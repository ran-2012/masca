...
> This is a fork of Masca but only contains snap (to reduce my disk load), 
if you want to use full functionality, please use the original repo [here](https://github.com/blockchain-lab-um/masca).
